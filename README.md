...
# GitHub Action - actions-upload-release-asset

![test](https://github.com/step-security/actions-upload-release-asset/workflows/test/badge.svg)
...
So, we are maintaining this action.
...
jobs:
  build:
    ...
    steps:
      ...
      - uses: step-security/actions-upload-release-asset@v1
        with:
